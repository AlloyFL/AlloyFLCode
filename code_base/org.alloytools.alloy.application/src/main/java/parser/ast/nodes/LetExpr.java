...
public class LetExpr extends ExprOrFormula {
    ...
    public ExprLet getExpr() {
        return expr;
    }

    /**
     * This method returns the let variable of the type VarExpr. Note that if we do
     * not invoke this method, then it's possible that the variable is wrapped with
     * NOOP unary expression.
     */
