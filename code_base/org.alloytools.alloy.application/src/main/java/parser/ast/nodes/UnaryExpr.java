...
public class UnaryExpr extends UnaryExprOrFormula {
    ...
    private static final long serialVersionUID = -7094292361766557527L;
    ...
    /**
     * This constructor is only used to create wrapper unary expressions. So it does
     * not have any mapping from the original Alloy node.
     */
