...
public abstract class UnaryExprOrFormula extends ExprOrFormula {
    ...
    /**
     * This setter is used quite often to create a NOOP unary expression, which
     * serves as the wrapper of another node. So we update the children field here
     * to avoid changing too many other places.
     */
