...
public class AUnitGuiUtil {
    ...
    public static JPanel makeSummary(int numP, int numF, int numE, int totalTime, Font font) {
        ...
        summary.add(new JLabel("", OurUtil.loadIcon("images/erroring.png"), JLabel.CENTER));
        ...
        JLabel errorLabel = new JLabel("<html>Error: <b><font color = F98824>" + numE, OurUtil.loadIcon("three.png"), JLabel.CENTER);
    ...
    public static JPanel makeSummaryBarDisplay(int width, int numP, int numF, int numE, int totalTime, Font font) {
        int total = numP + numF + numE;
        SummaryBarPanel summaryBar = new SummaryBarPanel(numP, numF, numE);
